    ...
    <div>
      ...
      <main className="min-h-screen">
        ...
        <section id="testimonials" className="py-16 bg-gray-50 px-6 md:px-0">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-800">What Legends Say</h2>
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Matt Bellamy</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Mark Cuban</h4>
                </div>
              </div>
            </div>
          </div>
